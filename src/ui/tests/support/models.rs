...
//! Shared UI test support for models fixtures and helpers.
//!
...
pub(crate) fn sample_model(commit_count: usize, files_per_commit: usize) -> AuditModel {
    ...
    AuditModel {
        ...
        commit_pages,
        payload: PayloadModel::Ok(Box::new(sample_payload_audit())),
...
pub(crate) fn build_model_from_fixture(fixture: &DiffFixture) -> AuditModel {
    ...
    AuditModel {
        ...
        payload: PayloadModel::Ok(Box::new(payload)),
